...
- **I am part of a research consortium comprising 40 academics from 7 major UK universities, as well as 25 external partners**. Our project entitled "_Participatory Harm Auditing Workbenches and Methodologies_" ([PHAWM](https://phawm.org)) was awarded **£3.5 million by Responsible AI and UKRI to propose methodologies and workbenches that enable end-users and decision-subjects with diverse backgrounds to participate in AI auditing**. The project started in May 2024 and will last for 42 months.

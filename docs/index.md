...
- **I research and supervise graduate students at the Itaipu Technology Park**, funded by **Itaipu Binacional** and the **Brazilian Ministry of Human Rights and Citizenship**. In the project entitled _"Human Rights Observatory"_ ([ObservaDH](https://observadh.mdh.gov.br/)), my team investigates the **automatic detection of hate speech**, the **impact of AI applications in technology-facilitated gender-based violence (TFGBV)**, and **the alignment of Large Language Models (LLMs) with human rights charters**. 

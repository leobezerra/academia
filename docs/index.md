...
Currently, **my main research focus is on promoting and sustaining accountability in artificial intelligence applications**. My goal is to propose an end-to-end policy framework to be used by governments and AI developers alike to ensure that AI applications be devised and operated in an accountable way. To achieve this, I am applying for funding opportunities to structure an **Observatory on the Potentially Incurred Social Damage from Artificial Intelligence (PISD.ai)**, which will survey current and future relevant real-world examples where the lack of appropriate AI regulation (potentially) incurs significant social damage. Critical examples include (i) **the role of social media recommendation algorithms in disinformation and its impact to democracy, human rights, and public health**, and; (ii) **the disruptive nature of generative AI**.
